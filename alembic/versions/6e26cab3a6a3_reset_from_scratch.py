...
Revision ID: 6e26cab3a6a3
Revises: 
Create Date: 2026-01-30 12:11:23.316573
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('test_hello',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('msg', sa.TEXT(), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name=op.f('test_hello_pkey'))
    )
